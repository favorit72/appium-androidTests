...
public class FooterPage extends DriverWait {
    ...
    //Click:
    @AndroidFindBy(xpath = "//*[@resource-id='com.rubetek.client:id/bottom_navigation_small_container'][1]")
    public MobileElement deviceList;
    @AndroidFindBy(xpath = "//*[@resource-id='com.rubetek.client:id/bottom_navigation_small_container'][2]")
    public MobileElement scenarioList;
    @AndroidFindBy(xpath = "//*[@resource-id='com.rubetek.client:id/bottom_navigation_small_container'][3]")
    public MobileElement eventsList;
    @AndroidFindBy(xpath = "//*[@resource-id='com.rubetek.client:id/bottom_navigation_small_container'][4]")
    public MobileElement statisticList;
    @AndroidFindBy(xpath = "//*[@resource-id='com.rubetek.client:id/bottom_navigation_small_container'][5]")
    ...
    //Text
    @AndroidFindBy(xpath = "//*[@resource-id='com.rubetek.client:id/bottom_navigation_small_item_title']")
